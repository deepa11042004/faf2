...
export function IndustriesSection() {
  return (
    <section id="industries" className="py-24 bg-[#FFFFFF]">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-[#11BDF2] font-semibold uppercase tracking-wider text-sm mb-2 block">
            Industries We Serve
          </span>
          <h2 className="text-4xl md:text-5xl font-poppins font-bold text-[#231F20] leading-tight mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {industries.map((industry, idx) => (
            <motion.div
              ...
              className="group relative rounded-2xl overflow-hidden h-48 md:h-56 shadow-sm hover:shadow-xl transition-all cursor-pointer"
            >
