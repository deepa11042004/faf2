...
export function StatsSection() {
  return (
    <section className="py-20 bg-gradient-to-b from-sky-50/50 via-slate-50 to-sky-50/30 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="relative group bg-sky-50/90 backdrop-blur-xl p-8 rounded-3xl border-4 border-sky-300 hover:border-sky-500 shadow-[0_8px_30px_rgba(2,132,199,0.12)] hover:shadow-[0_20px_40px_rgba(2,132,199,0.22)] transition-all duration-300 flex flex-col items-center text-center overflow-hidden"
            >
              ...
              <div className="relative mb-5">
                ...
                <div className="relative p-4 rounded-2xl bg-white text-[#0284C7] border border-sky-200 group-hover:bg-[#0284C7] group-hover:text-white group-hover:scale-110 transition-all duration-300 shadow-md">
                  {stat.icon}
                </div>
              </div>
